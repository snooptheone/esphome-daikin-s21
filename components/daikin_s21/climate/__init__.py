...
from .. import CONF_S21_ID, S21_CLIENT_SCHEMA, DaikinS21Client, daikin_s21_ns
...
CONFIG_SCHEMA = cv.All(
    climate.climate_schema(DaikinS21Climate).extend(
        {
            cv.GenerateID(CONF_S21_ID): cv.use_id(DaikinS21Climate),
